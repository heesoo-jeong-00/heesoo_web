...
function updateVideoSource() {
  ...
  if (isMobile) {
    newSrc = "../../files/ink/inkai_0-mobile.mp4";
  } else if (isTabletPortrait) {
    newSrc = "../../files/ink/inkai_0-mobile.mp4";
  } else {
    newSrc = "../../files/ink/inkai_0.mp4";
  }
...
setupVideoRepeat(document.getElementById('video5'), 1.2);
setupVideoRepeat(document.getElementById('video6'), 1.2);
setupVideoRepeat(document.getElementById('video7'), 1.2);
